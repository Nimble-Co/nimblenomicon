...
const items = [
  {
    ...
    callout:
      "<p><strong>Extra Arms?!</strong> Yes, you can dual wield 2-handed weapons or wear more than 1 shield, or Grapple 2 different creatures while hitting them both at the same time! Or any number of creative things, provided you have the arms to perform the task.</p>",
  },
  {
    kind: "standard",
    name: "Harbinger & Sovereign, Abyssal's Claim",
    subtitle: "_(Legendary Glaives)_",
    paragraphs: ["Set of 2 matching glaives, +4 extra arms while both are equipped."],
  },
  {
    kind: "standard",
  ...
  },
  {
    kind: "standard",
    name: "Vindication",
    subtitle: "_(Legendary Weapon of Animosity)_",
    paragraphs: [
  ...
  },
  {
    ...
    subtitle: "_(Uncommon wand, Cantrip (3 charges))_",
    recharge:
      "Heat the wand in a blacksmiths forge until it glows, then quench it in oil.",
  },
  {
    kind: "wand",
    name: "Wand of Dread Visage",
    subtitle: "_(Uncommon wand, Tier 2 (2 charges))_",
    recharge:
      "Place the wand in a freshly slain corpse. Leave it until only bones remain.",
  },
  {
    kind: "wand",
    name: "Wand of Glacier Strike",
    subtitle: "_(Very Rare wand, Tier 8 (1 charge))_",
    recharge:
      "Leave the wand at the bottom of a lake until it freezes over and thaws naturally.",
  },
  {
    kind: "wand",
    name: "Wand of Ride the Lightning",
    subtitle: "_(Very Rare wand, Tier 6 (2 charges))_",
    recharge:
      "Place at the highest point within 1 mile. Retrieve after 3 thunderstorms.",
  },
  {
    kind: "wand",
    name: "Wand of Barrier of Wind",
    subtitle: "_(Rare wand, Tier 2 (3 charges))_",
    recharge:
      "Hang the wand with wind chimes in a breezy area. Let it ring for 3 days.",
  },
  {
    kind: "wand",
    name: "Wand of Sacrifice",
    subtitle: "_(Very Rare wand, Tier 6 (1 charge))_",
    recharge:
      "Plant it in a new garden, leave it undisturbed until the flowers bloom.",
  },
  {
    kind: "wand",
    name: "Elderwyrm’s Majesty",
    subtitle: "_(Legendary wand, Tier 9 (1 charge))_",
    body: "This wand can cast Dragonform, turning into the type of dragon that last charged it.",
    recharge:
      "Give an ancient dragon a gift it truly desires.",
  },
  {
    kind: "wand",
    name: "Heartwood, Splinter of the Tree of Life",
    subtitle: "_(Legendary wand, Tier 9 (1 charge))_",
    body: "Cast Redeem with no required components.",
    recharge:
      "A sacred hymn must be sung over it ceaselessly for 100 years.",
  },
];

fs.writeFileSync(
  path.resolve("src/data/magical-items.json"),
  JSON.stringify(items, null, 2) + "\n",
);
console.log("magical-items.json", items.length);
