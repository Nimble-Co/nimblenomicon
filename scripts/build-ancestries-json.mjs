...
const items = [
  ...
  },
  {
    ...
    callout:
      "<p><strong>What About Half-Elves?</strong> Mix the ancestries however makes sense in your world. You can pick one ancestral bonus and use it instead of both, or use both half as effectively or half as often.</p>",
  },
  {
    section: "common",
    name: "Halfling",
  ...
  },
  {
    ...
    callout:
      "<p><strong>Flavor Is Free.</strong> Want to play a Stout Halfling instead of an Elusive one? An Optimistic Human instead of Tenacious? As long as it makes sense and the GM is on board, go for it!</p>",
  },
  {
    section: "exotic",
    name: "Bunbun",
  ...
  },
  {
    ...
    trait: "**Scurry.** Gain +2 armor if you moved on your last turn.",
  },
  {
    section: "exotic",
    name: "Stoatling",
  ...
  },
  {
    ...
    trait: "**Slow & Steady.** +4 Armor, –2 speed.",
  },
  {
    section: "exotic",
    name: "Wyrdling",
    ...
    callout:
      "<p><strong>Flavor Is Free.</strong> Want to be a leaping Frogfolk instead of a Bunbun? A Flameborn Kobold? A winged Fairy instead of a Birdfolk? A Badgerfolk instead of a Stoatling? As long as it makes sense and your GM is game, go for it!</p>",
  },
];

fs.writeFileSync(
  path.resolve("src/data/ancestries.json"),
  JSON.stringify(items, null, 2) + "\n",
);
console.log("ancestries.json", items.length);
