...
function coreRulesMarkdownDetailProps(
	...
	return {
		title: row.name,
		description: `${opts.descriptionLabel} — ${row.name}.`,
...
export function backgroundDetailPageProps(
	...
	return coreRulesMarkdownDetailProps(row, {
		descriptionLabel: 'Character background',
