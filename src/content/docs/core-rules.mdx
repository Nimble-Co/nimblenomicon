---
title: Core Rules
description: Nimble core rules — character creation, combat, gear, spells, and everything you need to play.
hidePageTitle: true
bannerInHero: true
...
### Step 1: Choose Your [Class](/search?type=class)
...
### Step 2: Choose Your [Ancestry](/search?type=ancestry) & [Background](/search?type=background)
