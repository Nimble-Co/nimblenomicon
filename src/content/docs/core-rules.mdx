...
import HeadingBlockList from '../../components/ui/HeadingBlockList.astro';
import TermLineList from '../../components/ui/TermLineList.astro';
import TermParagraphList from '../../components/ui/TermParagraphList.astro';
import {
...
<>
<h3>{sectionLabel}</h3>
<DataTable variant="core-rules" columns={columns} rows={rows} />
</>
))
}
...
<DataTable variant="core-rules" {...coreRulesWeaponsTable('melee')} />

### Ranged Weapons

<DataTable variant="core-rules" {...coreRulesWeaponsTable('ranged')} />
...
<DataTable variant="core-rules" {...miscAdventuringEquipmentTable()} />
...
<DataTable variant="core-rules" {...magicalItemRaritiesTable()} />

<HeadingBlockList blocks={magicalItemBlocks('standard')} />
...
<DataTable variant="core-rules" {...spellScrollCostsTable()} />
...
<DataTable variant="core-rules" {...wandCostsTable()} />

<HeadingBlockList blocks={magicalItemBlocks('wand')} />
