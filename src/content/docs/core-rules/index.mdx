...
<div class="nimble-full-bleed-hero">
  ...
  <div class="nimble-full-bleed-hero__bottom">
    <h1 id="_top" class="nimble-full-bleed-hero__title">Core Rules</h1>
    <HeroCallout />
  </div>
</div>
...
**Insight (WIL).** Your ability to understand people and situations beyond the obvious. Use Insight to sense motives, detect lies, read hidden emotions, make sense of clues, and when faced with uncertainty—you can think ahead or just “get” what is happening. Insight can be used to retroactively change situations:
