...
import MonsterFamily from '../../components/monsters/MonsterFamily.astro';
import MonsterKindShowcase from '../../components/monsters/MonsterKindShowcase.astro';
import MonsterStatBlock from '../../components/monsters/MonsterStatBlock.astro';
import LegendaryStatBlock from '../../components/monsters/LegendaryStatBlock.astro';
...
This stat block for a goblin serves as an example. Speed, armor, and saves use the defaults above when they are not called out on the block (this goblin is unarmored with speed 6). If he ever takes a total of 15 or more damage, he'll die. His LVL of 1/3 means 3 goblins are about as strong as a level 1 hero. On the goblin's turn, the GM could move him up to 6 spaces and stab (or shoot) in either order. Whenever an attack misses him, his family ability triggers.
