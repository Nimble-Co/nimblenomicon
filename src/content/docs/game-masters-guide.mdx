...
import BoonsList from '../../components/BoonsList.astro';
...
import MonsterFamily from '../../components/MonsterFamily.astro';
import MonsterKindShowcase from '../../components/MonsterKindShowcase.astro';
import MonsterStatBlock from '../../components/MonsterStatBlock.astro';
import SpellList from '../../components/SpellsList.astro';
import DataTable from '../../components/DataTable.astro';
import HeadingBlockList from '../../components/HeadingBlockList.astro';
import {
	chaosMagicTable,
	gmgGoldByLevelTable,
	gmgMonsterBuilderTable,
	magicalItemBlocks,
} from '../../utils/doc-presenters';
...
**Your job is NOT to foil the players or be their enemy.** The GM's job is to facilitate the fun and help them feel HEROIC! Yes, the <Reference term="Oathsworn" /> will deal more damage if you attack them, do it anyway. If you're playing intelligent monsters, maybe they catch on after a while and attack other players, but don't rob your players of the cool things they can do.
...
<Reference term="Assess" /> action) and they roll exceptionally well (e.g., 20+), feel free to give more than the bare minimum. For example, on a DC 12 Finesse check to secretly pick someone's pocket: on a 20+ perhaps they find some extra loot. Or, on a 20+ check to Create an Opening, they could get an additional die of damage as well!

**When information is necessary:** Choose one hero who "knows" the information. For instance: the
<Reference term="Hunter" /> knows about this forest, the <Reference term="Mage" /> knows what an arcane symbol means. Alternatively, have everyone roll a skill check and reward the hero with the highest roll with the information. They are the ones who knew it!
...
On a failed <Reference term="Assess" /> check (to encourage them to try again), you can inform the players of a monster's hidden strength, weakness, or technique that they won't be able to exploit until they succeed, encouraging more thoughtful play and adding more tactics to the encounter.
...
- **Cosmetic Items.** Equipment with a compelling description or name: The Pale Baron's <Reference term="Rapier" />. An axe that makes your eyes glow with flames while wielding it. Seeds that grow ever-blooming flowers. An unsettling cap made of teeth. An illusory cloak with ever-shifting colors.
...
failed check can impose minor consequences such as HP loss, a <Reference term="Wound" />, a Condition, or loss of an item. Multiple failures might escalate to severe consequences, such as failing the quest, losing a key ally, or even resulting in character death. Tips for Running Skill Challenges:
...
Be careful! Before you say "No, you can't do that…" consider letting it happen. Chances are, it won't break the campaign. Players may want to use their "combat only" abilities outside of combat, if the situation calls for it and it sounds reasonable, let them. For example, a <Reference term="Berserker" /> may rage before trying a Might check, or a <Reference term="Stormshifter" /> may shapeshift into an Owlbear—you can optionally give them advantage on the skill check or just allow them to succeed. If you're concerned about some strange thing happening over and over again, you can even say "because that idea is so cool, I'll let it happen, just this once.
...
<HeadingBlockList
	blocks={magicalItemBlocks(undefined, {
		source: 'game-masters-guide',
		adventuringRewardCategory: 'release-valve',
	})}
/>
...
<HeadingBlockList
	blocks={magicalItemBlocks(undefined, {
		source: 'game-masters-guide',
		adventuringRewardCategory: 'story',
	})}
/>
...
<HeadingBlockList
	blocks={magicalItemBlocks(undefined, {
		source: 'game-masters-guide',
		adventuringRewardCategory: 'combat',
	})}
/>

## Resting & Healing

When a party rests is up to you, as the GM. Offering one-time healing or directions to a hidden oasis where they can rest can be great quest rewards. Make sure you reward different classes, too. The <Reference term="Hunter" /> can spot rare medicinal herbs, the <Reference term="Stormshifter" /> could befriend an animal that shares the location of a safe hideaway, the <Reference term="Shepherd" /> or Oathsworn could cleanse and rededicate a holy site, etc.
...
<DataTable ariaLabel="Gold per level" {...gmgGoldByLevelTable()} />
...
<BoonsList level="minor" />

### Major Boons

<BoonsList level="major" />

### EPIC Boons

<BoonsList level="epic" />
...
**Dealing With Armor?** Heroes' critical hits, some spells, and damage type vulnerabilities ignore monster armor altogether. This means certain weapons and spells are better or worse against armored foes! This is also a great opportunity to remind your players about the <Reference term="Assess" /> action.
...
- **<Reference term="Target" /> Squishy Characters.** Make them use their actions to defend or run away and hide behind their stronger friends! Let the tanks feel good about Defending and Interposing.
...
- **<Reference term="Charmed" /> Allies.** Enemies cast powerful charms or illusions on one or more party members, forcing the heroes to fight their own while trying to break the spell.
...
- **Environmental <Reference term="Ally" />.** Heroes gain an advantage from the environment, a rampaging beast, a structure collapsing, or a natural disaster to help turn the tide. Just make sure you properly foreshadow what is coming and allow them to set up a cool moment, otherwise they can feel cheated.
...
<DataTable
	ariaLabel="Monster builder by level"
	tableClass="w-max min-w-full"
	{...gmgMonsterBuilderTable()}
/>
...
Once you have the base stats for the encounter, you can optionally add a cool flavorful ability to make these monsters feel and play differently. Abilities can be passive or trigger "On Movement," "On <Reference term="Attack" />," "On Miss," "On Hit," "On Damage," "On Crit," "On Death," and more.
...
- **Bloodthirsty.** Has advantage on attacks against <Reference term="Bloodied" /> targets.
...
- **<Reference term="Climbing" />.** Can traverse walls or ceilings normally.
...
- **Doom.** Attacks also <Reference term="Wound" /> the target.
...
<MonsterKindShowcase kind="goblins">
	<MonsterFamily family="goblins" />
</MonsterKindShowcase>

## Kobolds

<MonsterKindShowcase kind="kobolds">
	<MonsterFamily family="kobolds" />
</MonsterKindShowcase>

## Bandits

<MonsterKindShowcase kind="bandits">
	<MonsterFamily family="bandits" />
</MonsterKindShowcase>

## Snakemen

<MonsterKindShowcase kind="snakemen">
	<MonsterFamily family="snakemen" />
</MonsterKindShowcase>

## Dungeon Denizens

<MonsterKindShowcase kind="dungeon-denizens">
	<MonsterFamily family="mimics" />
	<MonsterFamily family="oozes" />
	<MonsterFamily family="stirges" />
</MonsterKindShowcase>

## Hill & Field

<MonsterKindShowcase kind="hill-and-field">
	<MonsterFamily family="gnolls" />

    <MonsterStatBlock monsterId="worg" />
    <MonsterStatBlock monsterId="blue-drake" />
    <MonsterStatBlock monsterId="griffon" />
    <MonsterStatBlock monsterId="bulette" />
    <MonsterStatBlock monsterId="troll" />
    <MonsterStatBlock monsterId="hill-giant" />
    <MonsterStatBlock monsterId="roc" />

</MonsterKindShowcase>

## Undead

<MonsterKindShowcase kind="undead">
	<MonsterFamily family="undead" />
</MonsterKindShowcase>

## Forest Denizens

<MonsterKindShowcase kind="forest-denizens">

<MonsterStatBlock monsterId="duskprowler" />
<MonsterStatBlock monsterId="basilisk" />
<MonsterStatBlock monsterId="druid" />

    <MonsterFamily family="briarbanes" />

</MonsterKindShowcase>

## Cultists & Horrors

<MonsterKindShowcase kind="cultists-and-horrors">
	<MonsterFamily family="cultists" />
	<MonsterFamily family="horrors" />
</MonsterKindShowcase>

## Underground

<MonsterKindShowcase kind="underground">
	<MonsterStatBlock monsterId="giant-spider" />
	<MonsterStatBlock monsterId="ettercap" />
	<MonsterStatBlock monsterId="nestweaver" />
	<MonsterStatBlock monsterId="umber-hulk" />
	<MonsterStatBlock monsterId="cloaker" />
	<MonsterStatBlock monsterId="great-worm" />
</MonsterKindShowcase>
...
They have interesting mechanics and weaknesses that can be uncovered through research ahead of time or using the <Reference term="Assess" /> action in combat.
...
**<Reference term="Bloodied" />.** They gain an additional dangerous ability as their HP drops to half.
...
- **Terrible Roar/Creepy Monologue/Taunt.** Creatures (or a creature) who hear this make a WIL save or are <Reference term="Frightened" /> for 1 turn.
- **Toss Around/Telekinetic Shove.** STR save or moved, <Reference term="Prone" />, etc.
...
| Party Level | HP (Med Armor) | HP (Hev Armor) | HP (Last Stand) | Save DC | <Reference term="Attack" /> Dmg (Small) | Attack Dmg (Big) |
| ----------- | -------------- | -------------- | --------------- | ------- | ------------------ | ---------------- |
| 1           | 50             | 35             | 10              | 10      | 8                  | 16               |
| 2           | 75             | 55             | 20              | 11      | 9                  | 18               |
...
For example, see <Reference term="Pudge the Blunderer" /> below. For a level 2 party he'll have 75 HP and Medium Armor. No need to stick strictly to the stat guidelines though his small attack hits for slightly less than suggested and, in exchange, his big attack hits for slightly more. When <Reference term="Bloodied" />, Pudge gets angry and his die size goes up, increasing his damage and reducing his chance to miss. For his Last Stand, he becomes far more dangerous, moving and using his big attack each turn.

<LegendaryStatBlock legendaryMonsterId="pudge-the-blunderer" />
...
<LegendaryStatBlock legendaryMonsterId="kelebek-and-poppy" />

### Legendary Bestiary

Official legendary stat blocks, ordered from lowest level to highest.

<LegendaryStatBlock legendaryMonsterId="grimbeak-the-unyielding" />
<LegendaryStatBlock legendaryMonsterId="thorn-quickblade" />
<LegendaryStatBlock legendaryMonsterId="ravager-of-the-lowlands" />
<LegendaryStatBlock legendaryMonsterId="nalzar-apex-predator" />
<LegendaryStatBlock legendaryMonsterId="queen-aranya-broodmother" />
<LegendaryStatBlock legendaryMonsterId="florindris-bane-of-the-forest" />
<LegendaryStatBlock legendaryMonsterId="general-flameheart" />
<LegendaryStatBlock legendaryMonsterId="vael-undying-necromancer" />
<LegendaryStatBlock legendaryMonsterId="titan-of-the-deep-woods" />
<LegendaryStatBlock legendaryMonsterId="ul-vek-psionic-despot" />
<LegendaryStatBlock legendaryMonsterId="dravok-all-seeing-tyrant" />
<LegendaryStatBlock legendaryMonsterId="azriel-lord-of-pain-and-flame" />
<LegendaryStatBlock legendaryMonsterId="gloomwing-the-cruel" />
<LegendaryStatBlock legendaryMonsterId="alaric-draegoth-the-crimson-count" />
<LegendaryStatBlock legendaryMonsterId="caerys-the-hollow-star" />
...
Unless otherwise noted, ongoing effects last for up to 1 minute or until <Reference term="Chaos" /> is triggered again.

<DataTable ariaLabel="Chaos table" {...chaosMagicTable()} />
